  ...
  const faqItems = [
    {
      ...
      answer:
        '[CONFIRM: client money / segregated account arrangements. This is a top-3 verifier question and needs a real answer.]',
    },
    {
      question: 'What happens if Fractionex goes out of business?',
      answer:
        'Your tokens represent rights in ring-fenced compartments that are legally separate from Fractionex the company. [VERIFY exact continuity/wind-down wording with legal.]',
    },
    {
      question: 'Can I lose more than I invest?',
      answer:
        'No. Your maximum loss is the amount you invest. Tokens carry no debt or liability beyond your holding. [CONFIRM with legal.]',
    },
    {
      question: 'Who values the properties?',
      answer:
        'Properties are revalued each cycle against verified income performance. [CONFIRM: independent valuer involvement — if yes, name the process; it\'s a strong trust point].',
    },
    {
      question:
        'Do I get a say in how the property is run?',
      answer:
    ...
    <div className="w-full bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="bg-gray-50 rounded-xl p-8 max-w-4xl mx-auto border border-gray-200">
            <div className="flex items-center justify-center gap-4 flex-wrap md:flex-nowrap">
              ...
              <div className="bg-white border-2 border-blue-600 rounded-lg p-4 text-center font-semibold text-black min-w-[140px]">
                Ring-fenced<br />compartment
              </div>
              <div className="text-2xl text-gray-400">→</div>
              ...
              <div className="text-2xl text-gray-400">→</div>
              <div className="bg-blue-50 border-2 border-blue-600 rounded-lg p-4 text-center font-semibold text-black min-w-[80px]">
                You
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 border-2 border-green-500">
              ...
              <ul className="space-y-3">
                <li className="flex gap-3">
                  ...
                  <span className="text-gray-700">Represents a defined share of one property's income and value</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-green-600 font-bold">✔</span>
                ...
                <li className="flex gap-3">
                  <span className="text-green-600 font-bold">✔</span>
                  <span className="text-gray-700">Recorded on-chain — your ownership is independently verifiable</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 border-2 border-red-200">
              ...
              <ul className="space-y-3">
                <li className="flex gap-3">
                  ...
                  <span className="text-gray-700">Not a cryptocurrency. No mining, no speculation token, no utility coin.</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          {/* Worked Example */}
          <div className="bg-blue-50 rounded-xl p-8 max-w-3xl mx-auto border-2 border-blue-600 mb-8">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="bg-white p-4 rounded-lg border-l-4 border-blue-600 mb-4">
                <p className="text-sm text-gray-600 italic">↓ Our management team improves occupancy and reduces costs ↓</p>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-2xl font-bold text-red-600">£1,100,000</span>
              </div>

              <div className="flex justify-between items-center pt-4 border-t-2 border-red-600 bg-red-50 p-4 rounded">
          ...
          <p className="text-center text-lg text-gray-700 max-w-2xl mx-auto mb-8">
            <span className="font-semibold">On a passive platform,</span> you get whatever the rent happens to be. <span className="font-semibold text-black">On Fractionex,</span> a professional team goes to work on your yield every day.
          </p>
              ...
              <table className="w-full">
                ...
                <tbody>
                  <tr className="border-b border-gray-200 hover:bg-white transition-colors">
                    ...
                    <td className="px-6 py-4 text-gray-600">On buy and sell [CONFIRM: both or buy only]</td>
                  </tr>
                  <tr className="border-b border-gray-200 hover:bg-white transition-colors">
                    <td className="px-6 py-4 text-gray-700">Property management fee</td>
                    <td className="px-6 py-4 font-semibold text-black">[CONFIRM]</td>
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-center text-gray-700 max-w-2xl mx-auto">
            Full, property-specific risk disclosures are published on every listing. <span className="font-semibold">Capital at risk.</span>
          </p>
        </div>
      </section>
      ...
      <section className="bg-red-600 py-20 text-white">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="mt-8 pt-8 border-t border-red-400">
            <Link
              href="#"
              className="text-red-50 hover:text-white text-sm underline"
            >
